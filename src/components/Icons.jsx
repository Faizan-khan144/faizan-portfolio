...
export function IconStar({ className = 'h-4 w-4' }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
      <path d="M12 2l2.9 6.26 6.86.63-5.2 4.53 1.54 6.74L12 16.9 5.9 20.16l1.54-6.74L2.24 8.9l6.86-.64L12 2z" />
    </svg>
  )
}
...
export function IconMail({ className = 'h-5 w-5' }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" aria-hidden="true">
      <path d="M3 5h18v14H3V5z" strokeLinecap="round" strokeLinejoin="round" />
...
export function IconInstagram({ className = 'h-5 w-5' }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" aria-hidden="true">
      <rect x="2.5" y="2.5" width="19" height="19" rx="5.5" strokeLinecap="round" strokeLinejoin="round" />
