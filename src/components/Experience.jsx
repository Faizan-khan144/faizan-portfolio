        ...
        <div className="flex flex-col">
          {experience.map((exp, i) => (
            <Reveal key={exp.title} delay={i * 0.06}>
              <div className="group relative flex flex-col gap-3 border-l-2 border-white/10 py-8 pl-8 transition-colors hover:border-accent md:flex-row md:items-start md:gap-12">
                <div className="absolute -left-[5px] top-10 h-2 w-2 rounded-full bg-accent"></div>
